...
# Delete RODA_ADV_DATABASE_URL from the environment, so it isn't accidently
# passed to subprocesses.  RODA_ADV_DATABASE_URL may contain passwords.
DB = Sequel.connect(ENV.delete('RODA_ADV_DATABASE_URL'), Settings.db&.to_hash&.compact! || {})
